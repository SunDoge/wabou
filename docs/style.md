...
Gaussian standard deviation passed directly to the renderer; it is not CSS blur
...
are not exposed because Wabou's backend-neutral box-shadow primitive accepts
neither.
