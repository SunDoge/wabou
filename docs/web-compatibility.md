...
| Events | Documented pointer, keyboard, focus, input, wheel and host events. Event objects expose only Wabou's typed fields and propagation/default-prevention behavior. |
