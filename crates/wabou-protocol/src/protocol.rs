...
#![allow(dead_code)]
// Wire records are exhaustively specified by docs/runtime-contract.md and the
// generated TypeScript/Rust ABI. Repeating prose on every operand would make
// schema changes harder to audit without adding semantic information.
#![allow(missing_docs)]
