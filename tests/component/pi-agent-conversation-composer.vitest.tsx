...
test("Pi Agent composer grows from a compact idle editor", () => {
  expect(promptComposerEditorHeightClass("")).toBe("h-12");
  expect(promptComposerEditorHeightClass("Short request")).toBe("h-12");
  expect(promptComposerEditorHeightClass("First line\nSecond line")).toBe(
    "h-16",
  );
  expect(promptComposerEditorHeightClass("One\nTwo\nThree")).toBe("h-20");
  expect(promptComposerEditorHeightClass("1\n2\n3\n4\n5")).toBe("h-24");
});
