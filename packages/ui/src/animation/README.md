...
This is the animation layer inside the public `@wabou/ui` package.
Applications import animation APIs from `@wabou/ui`.
...
```tsx
import { animate, animateKeyframes } from "@wabou/ui";
