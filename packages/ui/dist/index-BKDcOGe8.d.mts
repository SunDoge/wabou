...
import { Handle, NativeScrollbarStyle, WabouElementProps, WabouFloatingPlacement, WabouFloatingPosition } from "@wabou/core/renderer";
...
interface TransitionOptions extends Omit<AnimationOptions<number>, "autoplay" | "duration" | "onUpdate" | "onComplete"> {
...
type Placement = WabouFloatingPlacement;
...
declare function floatingFromNode(anchor: Handle, options?: FloatingPositionOptions): WabouFloatingPosition;
/** Build the explicit native positioning contract for a viewport point. */
declare function floatingFromPoint(point: PointAnchor, options?: FloatingPositionOptions): WabouFloatingPosition;
//#endregion
...
declare namespace index_d_exports {
  export { ActiveResult, AddTabOptions, Affine2D$1 as Affine2D, AnimationFrameCallback, Button, ButtonEvent, ButtonKeyEvent, ButtonPrimitive, ButtonProps, ButtonState, Center, CollapsiblePresence, CollapsiblePresenceProps, Column, ContainerMatch, ContainerSizeQuery, CreateButtonOptions, DismissEvent, DismissKeyEvent, Editor, EditorProps, FORM_ERROR, FloatingPositionOptions, FocusResult, FocusTarget, FocusWithinResult, FormDraft, FormDraftErrors, FormDraftFieldUpdater, FormDraftOptions, HoverResult, Icon, IconProps, Image, ImageProps, ImageResourceDescriptor, ImageResourceErrorEvent, ImageResourceHandle, ImageResourceReadyEvent, ImageResourceRequest, KeyedSelection, KeyedSelectionOptions, LayoutProps, Link, LinkProps, MeasuredSize, MeasuredSizeOptions, Modal, ModalControls, ModalEvent, ModalKeyEvent, ModalMotionOptions, ModalOpenChangeReason, ModalProps, ModalTriggerProps, NativeWidget, NativeWidgetConfig, NativeWidgetProps, NotificationControls, NotificationDismissReason, NotificationInput, NotificationItem, NotificationMotionOptions, NotificationPlacement, NotificationPriority, NotificationRegion, NotificationRegionProps, Notifications, NotificationsOptions, OverlayDismissReason, OverlayLayer, OverlayLayerOptions, OverlayPlane, OverlayPlaneProvider, OverlayPlaneProviderProps, OwnedImageResource, PasswordInput, PasswordInputProps, Path, PathBuilder, PathProps, Placement, PointAnchor, Popover, PopoverMotionOptions, PopoverProps, PopoverTriggerProps, Presence, PresencePhase, PressOptions, PressResult, PrimitiveProps, ProjectionBoundary, Pulse, PulseProps, RetainedItem, RetainedItems, RichText, RichTextProps, RichTextSpan, RichTextSpanProps, Ripple, RippleProps, Row, ScrollArea, ScrollAreaProps, ScrollResetOptions, ScrollResetTarget, ShortcutDefinition, ShortcutEvent, ShortcutHandler, ShortcutMap, ShortcutsResult, Spin, SpinProps, Svg, SvgProps, TabKey, TabKeyEvent, TabsOptions, TabsResult, Text, TextArea, TextAreaProps, TextInput, TextInputProps, TextProps, TransitionPresence, TransitionPresenceOptions, VectorPath$1 as VectorPath, VectorPathPaint, View, ViewProps, WabouClassList, WabouStyle$1 as WabouStyle, createActive, createAnimationFrame, createButton, createContainerMatch, createFileImageResource, createFocus, createFocusWithin, createFormDraft, createHover, createKeyedSelection, createMeasuredSize, createNetworkImageResource, createNotifications, createOverlayLayer, createOwnedImageResource, createPresence, createPress, createRetainedItems, createScrollReset, createShortcuts, createTabs, createTransitionPresence, floatingFromNode, floatingFromPoint, releaseImageResource, rotate2d$1 as rotate2d, translate2d$1 as translate2d, useOverlayPlane };
}
//#endregion
export { NotificationControls as $, rotate2d$1 as $n, FocusResult as $t, createPress as A, Path as An, createLoop as Ar, createMeasuredSize as At, PointAnchor as B, SvgProps as Bn, useMotionConfig as Br, FormDraftErrors as Bt, RetainedItem as C, ImageResourceHandle as Cn, SweepGeometry as Cr, ModalProps as Ct, PressOptions as D, NativeWidgetProps as Dn, animateKeyframes as Dr, MeasuredSize as Dt, ActiveResult as E, NativeWidgetConfig as En, animate as Er, ContainerSizeQuery as Et, PopoverMotionOptions as F, RichText as Fn, createTransition as Fr, KeyedSelection as Ft, OverlayDismissReason as G, TextInputProps as Gn, ImageResourceRequest as Gt, floatingFromPoint as H, TextArea as Hn, FormDraftOptions as Ht, PopoverProps as I, RichTextProps as In, normalizeSweepGeometry as Ir, KeyedSelectionOptions as It, OverlayPlane as J, VectorPathPaint as Jn, createNetworkImageResource as Jt, OverlayLayer as K, TextProps as Kn, OwnedImageResource as Kt, PopoverTriggerProps as L, RichTextSpan as Ln, MotionConfig as Lr, createKeyedSelection as Lt, PresencePhase as M, PathProps as Mn, createPulse as Mr, Column as Mt, createPresence as N, PrimitiveProps as Nn, createRotation as Nr, LayoutProps as Nt, PressResult as O, PasswordInput as On, createInterpolation as Or, MeasuredSizeOptions as Ot, Popover as P, ProjectionBoundary as Pn, createSweep as Pr, Row as Pt, useOverlayPlane as Q, WabouStyle$1 as Qn, createHover as Qt, FloatingPositionOptions as R, RichTextSpanProps as Rn, MotionConfigProvider as Rr, FORM_ERROR as Rt, ScrollAreaProps as S, ImageResourceErrorEvent as Sn, SweepAxis as Sr, ModalOpenChangeReason as St, createRetainedItems as T, NativeWidget as Tn, TransitionOptions as Tr, ContainerMatch as Tt, DismissEvent as U, TextAreaProps as Un, createFormDraft as Ut, floatingFromNode as V, Text as Vn, useReducedMotion as Vr, FormDraftFieldUpdater as Vt, DismissKeyEvent as W, TextInput as Wn, ImageResourceDescriptor as Wt, OverlayPlaneProviderProps as X, ViewProps as Xn, releaseImageResource as Xt, OverlayPlaneProvider as Y, View as Yn, createOwnedImageResource as Yt, createOverlayLayer as Z, WabouClassList as Zn, HoverResult as Zt, createShortcuts as _, EditorProps as _n, ReactiveTransition as _r, Modal as _t, AddTabOptions as a, Button as an, AnimationState as ar, NotificationPriority as at, createScrollReset as b, Image as bn, RotationOptions as br, ModalKeyEvent as bt, TabKeyEvent as c, ButtonPrimitive as cn, Easing as cr, Notifications as ct, createTabs as d, CreateButtonOptions as dn, LoopOptions as dr, Pulse as dt, FocusWithinResult as en, translate2d$1 as er, NotificationDismissReason as et, ShortcutDefinition as f, Link as fn, MotionInterpolationOptions as fr, PulseProps as ft, ShortcutsResult as g, Editor as gn, ReactiveAnimation as gr, SpinProps as gt, ShortcutMap as h, Affine2D$1 as hn, PulseOptions as hr, Spin as ht, createTransitionPresence as i, CollapsiblePresenceProps as in, AnimationOptions as ir, NotificationPlacement as it, Presence as j, PathBuilder as jn, createNativeLoopAnimation as jr, Center as jt, createActive as k, PasswordInputProps as kn, createKeyframeAnimation as kr, createContainerMatch as kt, TabsOptions as l, ButtonProps as ln, EasingFunction as lr, NotificationsOptions as lt, ShortcutHandler as m, createButton as mn, NativeLoopAnimationOptions as mr, RippleProps as mt, TransitionPresence as n, createFocusWithin as nn, createAnimationFrame as nr, NotificationItem as nt, FocusTarget as o, ButtonEvent as on, AnimationType as or, NotificationRegion as ot, ShortcutEvent as p, LinkProps as pn, NativeLoopAnimation as pr, Ripple as pt, OverlayLayerOptions as q, VectorPath$1 as qn, createFileImageResource as qt, TransitionPresenceOptions as r, CollapsiblePresence as rn, AnimationControls as rr, NotificationMotionOptions as rt, TabKey as s, ButtonKeyEvent as sn, AnimationValue as sr, NotificationRegionProps as st, index_d_exports as t, createFocus as tn, AnimationFrameCallback as tr, NotificationInput as tt, TabsResult as u, ButtonState as un, KeyframeAnimationOptions as ur, createNotifications as ut, ScrollResetOptions as v, Icon as vn, RepeatType as vr, ModalControls as vt, RetainedItems as w, ImageResourceReadyEvent as wn, SweepOptions as wr, ModalTriggerProps as wt, ScrollArea as x, ImageProps as xn, SweepAnimation as xr, ModalMotionOptions as xt, ScrollResetTarget as y, IconProps as yn, RotationAnimation as yr, ModalEvent as yt, Placement as z, Svg as zn, MotionConfigProviderProps as zr, FormDraft as zt };
//# sourceMappingURL=index-BKDcOGe8.d.mts.map