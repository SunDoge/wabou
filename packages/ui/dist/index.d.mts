...
declare function PromptComposerToolbar(props: ViewProps): JSX.Element;
/** Shrink-safe group for the composer tools preceding its primary action. */
declare function PromptComposerTools(props: ViewProps): JSX.Element;
//#endregion
