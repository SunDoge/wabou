import { $n as WabouStyle, $t as FormDraftFieldUpdater, A as createPress, An as ImageSource, Ar as createPulse, At as ModalControls, Bn as Svg, C as RetainedItem, Cr as SweepOptions, Ct as Pulse, Dn as ImageProps, Dr as createInterpolation, Dt as Spin, E as ActiveResult, En as Image, Er as animateKeyframes, Et as RippleProps, F as PopoverMotionOptions, Fn as PasswordInputProps$1, Fr as MotionConfig, Ft as ModalProps, Gn as TextInput, Gt as LayoutProps, Hn as Text, Ht as createMeasuredSize, I as PopoverProps$1, In as Path, Ir as MotionConfigProvider, Jn as VectorPath, Jt as KeyedSelectionOptions, Kn as TextInputProps, Kt as Row, Ln as PathBuilder, Lr as MotionConfigProviderProps, Lt as ContainerMatch, Mn as NetworkImageProps, Mr as createSweep, N as createPresence, Nn as NetworkImageSource, Nr as createTransition, Nt as ModalMotionOptions, O as PressResult, On as ImageResourceErrorEvent, Or as createKeyframeAnimation, P as Popover$1, Pn as PasswordInput$1, Pr as normalizeSweepGeometry, Pt as ModalOpenChangeReason, Qn as WabouClassList, Qt as FormDraftErrors, Rn as PathProps, Rr as useMotionConfig, Rt as ContainerSizeQuery, S as ScrollAreaProps, Sn as CodeEditorProps, Sr as SweepGeometry, St as createNotifications, T as createRetainedItems, Tn as IconProps, Tr as animate, Tt as Ripple, U as Placement, Un as TextArea, Ut as Center, Vn as SvgProps, Vt as createContainerMatch, W as PointAnchor, Wn as TextAreaProps, Wt as Column, Xn as View, Xt as FORM_ERROR, Yn as VectorPathPaint, Yt as createKeyedSelection, Zn as ViewProps, Zt as FormDraft, _ as createShortcuts, _n as Link, _r as RepeatType, an as FocusWithinResult, ar as AnimationOptions, b as createScrollReset, br as SweepAnimation, bt as Notifications, cn as CollapsiblePresence, cr as AnimationValue, d as createTabs, dr as KeyframeAnimationOptions, en as FormDraftOptions, fn as ButtonKeyEvent, fr as LoopOptions, ft as NotificationDismissReason, gr as ReactiveTransition, gt as NotificationPlacement, hn as ButtonState, hr as ReactiveAnimation, ht as NotificationMotionOptions, i as createTransitionPresence, in as FocusResult, ir as AnimationControls, it as OverlayLayer, jn as NetworkImage, jr as createRotation, k as createActive, kn as ImageResourceReadyEvent, kr as createLoop, kt as Modal, lr as Easing, lt as createOverlayLayer, mn as ButtonProps$1, mr as PulseOptions, n as TransitionPresence, nr as AnimationFrameCallback, on as createFocus, or as AnimationState, pr as MotionInterpolationOptions, qn as TextProps, qt as KeyedSelection, r as TransitionPresenceOptions, rn as createHover, rr as createAnimationFrame, sn as createFocusWithin, sr as AnimationType, st as OverlayPlaneProvider, t as index_d_exports, tn as createFormDraft, u as TabsResult, un as Button$1, ur as EasingFunction, vn as LinkProps, vr as RotationAnimation, vt as NotificationRegion, w as RetainedItems, wn as Icon, wr as TransitionOptions, x as ScrollArea, xn as CodeEditor, xr as SweepAxis, yn as createButton, yr as RotationOptions, yt as NotificationRegionProps, zr as useReducedMotion } from "./index-CtQAUp3c.mjs";
...
interface ImageViewportProps extends Omit<ViewProps, "children" | "ref" | "onWheel"> {
  source?: ImageSource;
