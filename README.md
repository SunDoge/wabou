...
The native backend is Winit + Taffy + Parley + Vello Hybrid:
...
offscreen Vello Hybrid capture all use the same retained document and widget
contracts.
...
Solid universal renderer
        ...
        ▼
QuickJS ───────────────► Rust host ──► retained Taffy/Vello scene
   ▲                         │
